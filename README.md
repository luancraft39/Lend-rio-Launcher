...
<body>
  ...
  <div class="container">
    ...
    <div class="card">
      ...
      <span class="toggle" onclick="toggleVersions()">⬇ Mostrar Versões</span>
    ...
    <div class="card">
      ...
      <a href="https://luancraft39.github.io/Lend-rio-tetris-edition/" class="btn" target="_blank">Jogar</a>
    </div>
  </div>
  ...
  <script>
    function toggleVersions() {
      const versions = document.getElementById("parkourVersions");
