...
<head>
  ...
  <style>
    ...
    .card h3 {
      ...
      background: linear-gradient(to bottom, #ffea75 0%, #ffc600 45%, #ffc600 50%, #00f0ff 55%, #00a8ff 100%);
  ...
  <div class="container">
    ...
    <div class="card">
      ...
      <div class="versions" id="dashVersions">
        <a href="https://luancraft39.github.io/Lend-rio-Dash/" target="_blank">Versão 1.0 (Antiga)</a>
      </div>
    </div>
